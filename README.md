...
Real-time aircraft surveillance and tactical analysis platform with live OpenSky Network data, AI-powered threat assessment, and immersive pilot POV mode.
...
- **SENTINEL AI** — GPT-4o tactical threat analysis with pattern recognition
